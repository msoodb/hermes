...
void hrms_actuator_hub_init(void) {
  ...
  hrms_servomotor_set_type(0, BLFM_SERVO_TYPE_PROPORTIONAL);  // Servo1 - PA0
#endif
#if BLFM_ENABLED_SERVO2
  hrms_servomotor_set_type(1, BLFM_SERVO_TYPE_PROPORTIONAL);  // Servo2 - PA1
#endif
#if BLFM_ENABLED_SERVO3
  hrms_servomotor_set_type(2, BLFM_SERVO_TYPE_PROPORTIONAL);  // Servo3 - PA2
#endif
#if BLFM_ENABLED_SERVO4
  hrms_servomotor_set_type(3, BLFM_SERVO_TYPE_PROPORTIONAL);  // Servo4 - PA3
#endif
#endif

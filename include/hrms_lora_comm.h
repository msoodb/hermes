...
#ifndef HRMS_LORA_COMM_H
#define HRMS_LORA_COMM_H
...
/**
 * @file hrms_lora_comm.h
 * @brief LoRa SX1278 communication module following clean sensor/actuator pattern
 * 
 * This module provides a clean interface for SX1278 LoRa radio communication,
 * following the same pattern as sensor and actuator modules.
 */

/**
 * Initialize SX1278 LoRa communication module
